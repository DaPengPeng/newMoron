...
@property (nonatomic,copy) NSString *screen_name,*name,*province,*city,*location,*userInfoDescription,*url,*profile_image_url,*domain,*gender,*created_at,*avatar_large,*verified_reason;
